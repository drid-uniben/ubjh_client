        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <a href={`/files/${articleData.download.file}`} download className="inline-flex items-center gap-2 bg-journal-maroon text-white px-8 py-2 rounded-lg transition-colors text-sm font-semibold hover:bg-journal-maroon-dark">
